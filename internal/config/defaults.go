...
[load]
# Default llama-server arguments, passed after the model path and bind
# address. Each entry is a name/value pair; value may be empty for a
# standalone flag. Per-model arguments are appended after these.
args = []
